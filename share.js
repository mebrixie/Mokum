(function() {
    ...
    function close(args) {
        ...
        foreground.innerHTML = '<img style="width:16px;height:16px;margin-bottom:-3px;margin-right:1px" src="http://mokum.place/static/images/icons/internal.png?v=e471e9afdf04ae568dcbddb5584fc6c0"> ' + message + ' <a href="#" id="ff__close" style="margin-left:1em;color:#1030cc">' + 'close' + '</a>';
    ...
    if (document.getElementsByTagName('head').length == 0 ||
        ...
        window.location.href = 'http://mokum.place/?link=' + escape(window.location.href);
    } else {
        bookmarklet();
    }
})();
